...
public class BlockEntities {
    ...
    public static final RegistrySupplier<BlockEntityType<MovingLightBlockEntity>> MOVING_LIGHT = BLOCK_ENTITIES.register("moving_light", () -> new BlockEntityType<>(MovingLightBlockEntity::new, Set.of(Blocks.MOVING_LIGHT_BLOCK.get())));
