...
public class MovingLightFixture extends Fixture {
    ...
    private static final Identifier TILT_MODEL = Identifier.fromNamespaceAndPath(Theatrical.MOD_ID, "block/moving_light/moving_head_tilt");
    private static final Identifier PAN_MODEL = Identifier.fromNamespaceAndPath(Theatrical.MOD_ID, "block/moving_light/moving_head_pan");
    private static final Identifier STATIC_MODEL = Identifier.fromNamespaceAndPath(Theatrical.MOD_ID, "block/moving_light/moving_head_static");
