...
public class LEDFresnelFixture extends Fixture {
    ...
    private static final Identifier TILT_MODEL = Identifier.fromNamespaceAndPath(Theatrical.MOD_ID, "block/fresnel/fresnel_body_only");
    private static final Identifier PAN_MODEL = Identifier.fromNamespaceAndPath(Theatrical.MOD_ID, "block/fresnel/fresnel_handle_only");
    private static final Identifier STATIC_MODEL = Identifier.fromNamespaceAndPath(Theatrical.MOD_ID, "block/fresnel/fresnel_hook_bar");
