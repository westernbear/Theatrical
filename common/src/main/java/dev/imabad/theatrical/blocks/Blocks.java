...
public class Blocks {
    ...
    public static final RegistrySupplier<Block> ART_NET_INTERFACE = register("artnet_interface", ArtNetInterfaceBlock::new);
    ...
    public static final RegistrySupplier<BasicLightingDeskBlock> BASIC_LIGHTING_DESK = register("basic_lighting_desk", BasicLightingDeskBlock::new);
